...
namespace TheITBlog.Services
{
    public class BasicSlugService : ISlugService
    {
        ...
        //Check if Slug is Unique or if already in database
        public bool IsUnique(string slug)
        {
            return !_dbContext.Posts.Any(p => p.Slug == slug);
        }

        //Slug String Builder - Creates Slug from input Blog post Title (Method)
        ...
        //RemapInternationalCharToAscii Method called by the UrlFriendly Method above
        //detechs international characters if included in Title
